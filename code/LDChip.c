...
#define DATE_B 30		/*数组一维数值*/
	uint8 code sRecog[DATE_A][DATE_B] =
	{
		...
		"ti gao liang du", \
		"jiang di liang du", \
		"tiao se wu shi wu shi ling", \
		"tiao se wu shi ling wu shi", \
		"tiao se ling wu shi wu shi", \
		"tiao se wu shi wu shi wu shi",\
		"ce liang wen du",\
		"ce liang qi ya",\
		"ce liang hai ba ",\
		"kai men yi er san si", \
		"guan men",\
		"ce liang guang zhao qiang du",\
		"guan bi ce liang",\
	};	/*添加关键词，用户修改*/
